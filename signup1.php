...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="#"><h1>Dukaan.com</span></h1> </a>
		  </div>
...
<form action="acct_created1.php" method="post">
  ...
  <fieldset>
    ...
    <input type="text" id="name" pattern="[a-zA-Z]+" name="user_add" require title="Only alphabets allowed">
	<label for="name">Pincode:</label>
    <input type="text" id="name"  name ="user_pin"  require title="Only numbers allowed">
	<label for="name">City:</label>
    <input type="text" id="name" pattern="[a-zA-Z]+" name="user_city" require title="Only alphabets allowed">
	<label for="name">State:</label>
    <input type="text" id="name" pattern="[a-zA-Z]+" name="user_state" require title="Only alphabets allowed">

...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="index.php"><h1>Dukaan.com</span></h1> </a>
		  </div>
			...
			<div class="products-grids">
				...
				<div class="col-md-5 grid-single">		
						<div class="flexslider">
							...
							//	echo '$username $username $username $username $username $username $username $username'; 
								...
								<div class="col-md-7 single-text">
									...
									<br>
									<h4>Full Name:-</h4> <input type="text" size="30" name="fullname" title="Only alphabets allowed" value='<?php echo $username;?>'  />
									<h4>Shipping Address:-</h4> <input type="text" size="30" rows="3" cols="30" name="address"  value="<?php printf ("%s",$row["addr"]); ?>">
									<h4>Pin Code:-</h4> <input type="text" size="6" name="pincode" pattern="\d{6}" title="6 digit postal code" value="<?php printf ("%s",$row["pin"]); ?>" >
									<h4>City:-</h4> <input type="text" size="15" name="city" pattern="[a-zA-Z]+"  title="Only alphabets allowed" value="<?php printf ("%s",$row["city"]); ?>">
									<h4>State:-</h4> <input type="text" size="30" name="state" pattern="[a-zA-Z]+" title="Only alphabets allowed" value="<?php printf ("%s",$row["state"]); ?>">
									<h4>Mobile No.:-</h4> <input type="tel" name="mobile" pattern="[\+]\d{12}" require   title="Format: +91XXXXXXXXXX" value="<?php printf ("%s",$row["mobile"]); ?>">
									<br><br>
									<h2>Payment Method:</h2> <br>
									<!--<input type="radio" checked> Cash on Delivery (COD)<br>-->
									<input type="radio" checked> Paytm karo!
									<br><br>
